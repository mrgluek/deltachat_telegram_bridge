...
- **Telegram Rich Post, Video & Album WebXDC Packaging**: Automatically packages long-form Telegram channel posts (with tables, spoilers, blockquotes), video posts, and multi-image albums into standalone, interactive WebXDC applications (`.xdc`). Apps feature offline reading and video playback:
  ...
  - **Smart Overflow Handling**: Videos exceeding 20 MB, exceeding the 50 MB package budget, or marked as "Media is too big" by Telegram web embeds are rendered as elegant preview cards with duration badges, poster images, and a prominent «Смотреть все видео в Telegram ↗» button linking directly to the Telegram post.
