...
async def main():
    ...
    # Commands react to new messages only. CommandHandler also matches edited
    # messages by default, which re-ran a command whenever its message was
    # edited (and crashed on update.message being None).
    _NEW_MSG = filters.UpdateType.MESSAGE
    tg_app.add_handler(CommandHandler("start", tg_start_command, filters=_NEW_MSG))
    tg_app.add_handler(CommandHandler("help", tg_help_command, filters=_NEW_MSG))
    tg_app.add_handler(CommandHandler("donate", tg_donate_command, filters=_NEW_MSG))
    tg_app.add_handler(CommandHandler("id", tg_id_command, filters=_NEW_MSG))
    tg_app.add_handler(CommandHandler("stats", tg_stats_command, filters=_NEW_MSG))
    tg_app.add_handler(CommandHandler("status", tg_status_command, filters=_NEW_MSG))
    tg_app.add_handler(CommandHandler("invite", tg_invite_command, filters=_NEW_MSG))
    tg_app.add_handler(CommandHandler("inviteqr", tg_inviteqr_command, filters=_NEW_MSG))
    # Bridge commands (TG side)
    tg_app.add_handler(CommandHandler("bridge", tg_bridge_command, filters=_NEW_MSG))
    tg_app.add_handler(CommandHandler("unbridge", tg_unbridge_command, filters=_NEW_MSG))
    # Admin management commands
    tg_app.add_handler(CommandHandler("adminadd", tg_adminadd_command, filters=_NEW_MSG))
    tg_app.add_handler(CommandHandler("adminremove", tg_adminremove_command, filters=_NEW_MSG))
    tg_app.add_handler(CommandHandler("admins", tg_admins_command, filters=_NEW_MSG))
    # Channel bridging commands
    tg_app.add_handler(CommandHandler("channeladd", tg_channeladd_command, filters=_NEW_MSG))
    tg_app.add_handler(CommandHandler("channels", tg_channels_command, filters=_NEW_MSG))
    tg_app.add_handler(CommandHandler("groups", tg_groups_command, filters=_NEW_MSG))
    tg_app.add_handler(CommandHandler("channel", tg_channel_command, filters=_NEW_MSG))
    tg_app.add_handler(MessageHandler(_NEW_MSG & filters.COMMAND & filters.Regex(r'^/channel\d+$'), tg_channel_command))
    tg_app.add_handler(CommandHandler("channelqr", tg_channelqr_command, filters=_NEW_MSG))
    tg_app.add_handler(MessageHandler(_NEW_MSG & filters.COMMAND & filters.Regex(r'^/channel\d+qr$'), tg_channelqr_command))
    tg_app.add_handler(MessageHandler(_NEW_MSG & filters.COMMAND & filters.Regex(r'^/channelqr\d+$'), tg_channelqr_command))
    tg_app.add_handler(CommandHandler("channelremove", tg_channelremove_command, filters=_NEW_MSG))
    tg_app.add_handler(CommandHandler("channeldelete", tg_channelremove_command, filters=_NEW_MSG))
    tg_app.add_handler(CommandHandler("filters", tg_filters_command, filters=_NEW_MSG))
    tg_app.add_handler(CommandHandler("filteradd", tg_filteradd_command, filters=_NEW_MSG))
    tg_app.add_handler(CommandHandler("filterdel", tg_filterdel_command, filters=_NEW_MSG))
    tg_app.add_handler(CommandHandler("filterremove", tg_filterdel_command, filters=_NEW_MSG))
    tg_app.add_handler(CommandHandler("cleanup", tg_cleanup_command, filters=_NEW_MSG))
    tg_app.add_handler(CommandHandler("catchup", tg_catchup_command, filters=_NEW_MSG))
    tg_app.add_handler(CommandHandler("reconcile", tg_catchup_command, filters=_NEW_MSG))
    tg_app.add_handler(CommandHandler("userbotsync", tg_userbotsync_command, filters=_NEW_MSG))
    tg_app.add_handler(CommandHandler("userbotjoin", tg_userbotjoin_command, filters=_NEW_MSG))
    tg_app.add_handler(CommandHandler("botsend", tg_botsend_command, filters=_NEW_MSG))
